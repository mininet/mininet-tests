...
# 2 TCP sources
odir=tcp-n3-bw$bw
#sudo python dctcp.py --bw $bw --maxq 1000 --dir $odir -t $t -n 3
...
function ecn {
# 2 TCP-ECN sources
odir=tcpecn-n3-bw$bw
sudo python dctcp.py --bw $bw --maxq 1000 --dir $odir -t $t -n 3 --ecn
sudo python ../util/plot_rate.py --maxy $bw -f $odir/txrate.txt -o $odir/rate.png
sudo python ../util/plot_queue.py -f $odir/qlen_s1-eth1.txt -o $odir/qlen.png
sudo python ../util/plot_tcpprobe.py -f $odir/tcp_probe.txt -o $odir/cwnd.png
}
...
# 2 DCTCP sources
odir=dctcp-n3-bw$bw
sudo python dctcp.py --bw $bw --maxq 1000 --dir $odir -t $t -n 3 --dctcp
sudo python ../util/plot_rate.py --maxy $bw -f $odir/txrate.txt -o $odir/rate.png
sudo python ../util/plot_queue.py -f $odir/qlen_s1-eth1.txt -o $odir/qlen.png
sudo python ../util/plot_tcpprobe.py -f $odir/tcp_probe.txt -o $odir/cwnd.png
}
